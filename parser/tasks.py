...
def parse_cv_task(self, cv_upload_id):
    """
    Parse CV and extract skills
    Runs as a Celery task with retry logic
    """
    try:
        ...
        logger.info(f"Successfully parsed CV: {cv_upload_id}, extracted {len(result['skills'])} skills")
